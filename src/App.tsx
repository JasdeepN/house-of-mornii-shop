...
function AppContent() {
  // Auth modal state — managed at app level to render outside zIndex container
  ...
  return (
    <>
      ...
      {/* Auth modals — rendered outside zIndex: 2 container to avoid stacking context trapping */}
      <LoginModal
        open={showLogin}
